...
Assert-Prius ($unit.Geometry.Shape.MajorRadius -eq '24.5') 'Incorrect half-length.'
Assert-Prius ($unit.Geometry.Shape.MinorRadius -eq '11.5') 'Incorrect half-width.'
Assert-Prius ($unit.Geometry.Shape.Height -eq '18.5') 'Incorrect height.'
